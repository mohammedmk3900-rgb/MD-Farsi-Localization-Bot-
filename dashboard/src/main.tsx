...
function App(){
 ...
 return <div className="shell">
  <header><div className="brand"><div className="logo">🇮🇷</div><div><small>MD FARSI LOCALIZATION</small><h1>COMMAND CENTER <b>V8</b></h1><p>مرکز عملیات حرفه‌ای فارسی‌سازی Millennium Dawn</p></div></div><div className={"status "+status}>● {status==="healthy"?"SYSTEM ONLINE":status==="degraded"?"SYSTEM DEGRADED":"SYSTEM CHECKING"}</div></header>
  ...
  <footer><span>MD Farsi Localization • Command Center V8</span><span>Source: {d.source} • Project {d.project.id}</span></footer>
 </div>
}
